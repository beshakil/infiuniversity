...
const App = () => {
  return (
    <div className="min-h-screen selection:bg-brand-500 selection:text-white">
      ...
      {/* --- ACADEMICS SECTION --- */}
      <section id="academics" className="pt-72 py-32 -mt-48 relative overflow-hidden hhero-gradient">
...
<div className="flex space-x-4">
                <a href="#" className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-brand-500 hover:border-brand-500 transition-all group">
                  <svg className="w-5 h-5 text-white/40 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
